...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Group", url="https://t.me/Botchatall"),
            InlineKeyboardButton(text="🛠️ Main Channel", url="https://t.me/Team_Sonu1"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [🦋⃟≛⃝🇸𝕠𝕟𝕦≛⃝🖤](https://t.me/Contact_AdminSbot)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
